...
class _$NotificationItemImpl implements _NotificationItem {
  ...
  @override
  String toString() {
    return 'NotificationItem(id: $id, userId: $userId, title: $title, message: $message, type: $type, read: $read, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, userId, title, message, type, read, createdAt);
