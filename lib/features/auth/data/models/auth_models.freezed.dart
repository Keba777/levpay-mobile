...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, String fingerprint});
}
...
class _$LoginRequestImpl implements _LoginRequest {
  const _$LoginRequestImpl(
      {required this.email, required this.password, required this.fingerprint});
  ...
  @override
  String toString() {
    return 'LoginRequest(email: $email, password: $password, fingerprint: $fingerprint)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, password, fingerprint);
...
abstract class _LoginRequest implements LoginRequest {
  const factory _LoginRequest(
      ...
      required final String fingerprint}) = _$LoginRequestImpl;
...
class _$RegisterRequestImpl implements _RegisterRequest {
  ...
  @override
  String toString() {
    return 'RegisterRequest(email: $email, password: $password, fingerprint: $fingerprint, firstName: $firstName, lastName: $lastName, phone: $phone)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, fingerprint, firstName, lastName, phone);
